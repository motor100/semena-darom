        ...
        <div class="col-6">
          <div class="dp-item delivery-item">
            ...
            <div class="dp-item__radio delivery-item-radio">
              <input type="radio" name="delivery-radio" id="sdek-radio" class="custom-radio" checked>
              <label for="sdek-radio" class="custom-radio-label"></label>
            </div>
          </div>
        </div>
        <div class="col-6">
          <div class="dp-item delivery-item">
            ...
            <div class="dp-item__radio delivery-item-radio">
              <input type="radio" name="delivery-radio" id="russian-post-radio" class="custom-radio">
              <label for="russian-post-radio" class="custom-radio-label"></label>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-6">
          <div class="dp-item payment-item">
            ...
            <div class="dp-item__radio payment-item-radio">
              <input type="radio" name="payment-radio" id="russian-post-radio" class="custom-radio" checked>
              <label for="russian-post-radio" class="custom-radio-label"></label>
            </div>
          </div>
        </div>
        <div class="col-6">
          <div class="dp-item payment-item">
            ...
            <div class="dp-item__radio ayment-item-radio">
              <input type="radio" name="payment-radio" id="sdek-radio" class="custom-radio">
              <label for="sdek-radio" class="custom-radio-label"></label>
            </div>
          </div>
        </div>
        <div class="col-6">
          <div class="dp-item payment-item payment-item-last">
            ...
            <div class="dp-item__radio payment-item-radio">
              <input type="radio" name="payment-radio" id="russian-post-radio" class="custom-radio">
              <label for="russian-post-radio" class="custom-radio-label"></label>
            </div>
          </div>
        </div>
